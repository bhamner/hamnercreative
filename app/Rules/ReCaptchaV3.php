...
class ReCaptchaV3 implements ValidationRule
{
    ...
    {
        // Send a POST request to the google siteverify service to validate
        ...
        if ($siteVerify->successful()) {
            ...
            // The action didn't match the one set in the button's data-action.
