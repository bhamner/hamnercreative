...
<html lang="en">
  ...
  <body class="app-layout">
    ...
    <header class="navbar app-header sticky-top bg-dark flex-nowrap p-0 shadow" data-bs-theme="dark">
      <a class="navbar-brand col-lg-2 me-0 px-3 fs-6 text-white" href="{{ route('welcome') }}">
      ...
      @isset($dates)
      <form method="get" action="" class="app-header-date-filter d-flex align-items-center ms-2 ms-lg-3 my-0">
        <select id="date_filter" name="date" class="form-select form-select-sm" aria-label="date_filter" onchange="this.form.submit()">
      ...
      @endisset
      <ul class="navbar-nav app-header-nav flex-row flex-nowrap align-items-center ms-auto px-3 gap-2">
        @include('partials.user-account-menu', ['dark' => true, 'fixed' => true, 'class' => 'd-none d-lg-block'])
    ...
    @include('partials.app-mobile-nav')

    <div class="container-fluid">
      <div class="row flex-lg-nowrap">
        @include('navigation.app')
        <main class="col-12 col-lg-10 ms-lg-auto px-lg-4 pt-3">
          @yield('content')
        </main>
      </div>
    </div>
