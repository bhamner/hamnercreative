...
@section('title') {{ config('app.name') }} - Enter Code @stop
@section('content')
<main class="text-center">
  ...
  <form method="post" action="/validate">
    ...
    <h1 class="h3 my-5 fw-normal">Please Enter your Client Code</h1>

    <div class="form-floating w-50 mx-auto">
      <input type="password" name="client_code" class="form-control" placeholder="Client Code" autocomplete="off" minlength="14" maxlength="14" required>
      <label for="floatingPassword">&bull; &bull; &bull; &bull; &bull; &bull; &bull; &bull; &bull; &bull; &bull; </label>
    </div>

    <button class="w-50 btn btn-lg btn-primary mx-auto my-5" type="submit">Validate</button>
